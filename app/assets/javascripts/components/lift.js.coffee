...
@Lift = React.createClass
  ...
  handleEdit: (e) ->
    ...
    data =
      ...
      respsperformed: ReactDOM.findDOMNode(@refs.respsperformed).value
      onerm: @state.onerm
    $.ajax
      method: 'PUT'
      url: "/lifts/#{ @props.lift.id }"
  ...
  reCalculateOneRm: ->
    @setState onerm: @getOneRm( ReactDOM.findDOMNode(@refs.weightlifted).value, ReactDOM.findDOMNode(@refs.respsperformed).value)
  ...
  liftRow: ->
    React.DOM.tr null,
      ...
      React.DOM.td null, @props.lift.respsperformed
    ...
    React.DOM.tr null,
      ...
      React.DOM.td null,
        React.DOM.input
          ...
          min: '1'
          max: '10'
          defaultValue: @props.lift.respsperformed
          ref: 'respsperformed'
          onChange: @reCalculateOneRm
      React.DOM.td null,
        @state.onerm
